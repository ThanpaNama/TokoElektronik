...
<body class="bg-gray-100">
    ...
    <nav class="bg-white shadow py-3">
        <div class="container mx-auto flex justify-between items-center">
            ...
            <div class="space-x-5">
                <a href="{{url('/')}}" class="text-black bg-blue-500 px-4 py-3 rounded">Beranda</a>
                <a href="{{url('/kategori')}}" class="text-black hover:bg-blue-500 px-4 py-3 rounded">Kategori</a>
                <a href="{{url('/aboutus')}}" class="text-black hover:bg-blue-500 px-4 py-3 rounded">Tentang Kami</a>
    ...
    <!-- Hero Section -->
    <section class="bg-blue-300 py-56">
        <div class="container mx-auto text-center">
            <h1 class="text-4xl font-bold text-black mb-4 relative" style="bottom: 72px">"Solusi Komponen Elektronik Terpercaya dari Nusantara"</h1>
            <h2 class="text-3xl font-bold text-black mb-6 relative" style="bottom: 72px">Component Marketplace for your Electronical Parts</h2>

            <!-- Search Box -->
            <div class="mt-8">
                <form class="flex justify-center relative" style="top: 64px">
